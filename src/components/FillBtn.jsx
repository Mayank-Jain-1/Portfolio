...
const Fillbtn = ({text,className}) => {
  return (
    ...
    <button className={`relative border flex justify-center items-center w-full border-brandGreen px-6 sm:px-16 h-10 sm:h-12 font-mono text-brandGreen text-xs sm:text-base tracking-widest
