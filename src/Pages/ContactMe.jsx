...
const ContactMe = () => {
  ...
  return (
    <section className="w-full lg:h-screen py-16 px-1 sm:px-3 md:px-6 lg:px-8 relative flex flex-col  lg:flex-row lg:items-center justify-center">
      <div>
      ...
      <div className="mt-16">
      <iframe src="https://snazzymaps.com/embed/457201" width="100%" height="500px" className="border-none px-4">
